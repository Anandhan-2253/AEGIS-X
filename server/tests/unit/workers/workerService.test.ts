...
jest.mock('../../../src/config/queue', () => ({
  addAnalysisJob: jest.fn(async (name: JobType) => ({ id: `${name}-job-id` })),
...
const { workerService } = require('../../../src/services/workerService') as typeof import('../../../src/services/workerService');

...
function boundContext(raw) {
    return (0, sanitizer_1.truncateForTokenLimit)(raw, MAX_CONTEXT_CHARS);
}
exports.promptTemplates = {
    incidentSummary(input) {
